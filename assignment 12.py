...
public class SalesCountryDriver { public static void main(String[] args) {
...
#  SalesCountryReducer.java package SalesCountry;
...
Text key = t_key; int frequencyForCountry = 0; while (values.hasNext()) {
...
#   SalesMapper.java package SalesCountry; import java.io.IOException;
...
Text, IntWritable> { private final static IntWritable one = new IntWritable(1);
